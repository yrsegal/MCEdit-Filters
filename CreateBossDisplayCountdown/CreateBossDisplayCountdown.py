...
def perform(level, box, options):
	...
	elif bossDisplayCountdownProperties != None:
...
def generateRedstone(box, (dragonPos, type, typeSpecific), detailedLog):
	...
	summonDragon = "/summon EnderDragon "+str(dragonX)+" "+str(dragonY)+" "+str(dragonZ)+" {Riding:{id:Minecart,Invulnerable:1},Attributes:[{Name:generic.maxHealth,Base:"+str(baseHealth)+"}],HealF:"+str(baseHealth)+",CustomeNameVisible:1,CustomName:\""+name+"\"}"
